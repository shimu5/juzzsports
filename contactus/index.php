...
<head>
    ...
    require_once "ContactUsManager.php";
    ?>
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="main">
                            ...
                            <?php $breadcrumbArr = array("Home" => "../index.php?s=1&p=1", "Contact Us" => "index.php?s=5", "Contact Information" => "#"); ?>
                            <?php include_once "../include/breadcrumb.php"; ?>
                            <?php echo (isset($_GET['success']) && intval($_GET['success']) ? '<div class="alert alert-success" for="contact">Your message has been successfully send.</div>' : '') ?>
                            <?php
                            // Dynamically Set page title and add category button
                            $titleArr = array('title' => 'Contact Information');
                            ?>
