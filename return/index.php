    	...
    	<div class="row">
        	<div class="col-xs-12">
            	<div class="main">
                    ...
                    <?php $breadcrumbArr = array("Home" => "../index.php?s=1&p=1", "My Account" => "../customer/index.php?s=6","Return Request" => "#"); ?>
                    <?php include_once "../include/breadcrumb.php";?>
                    <?php
                        // Dynamically Set page title and add category button
                        $titleArr = array('title' => 'Return Requests List');
                    ?>
                 ...
                 <div class="about-col-7" style="margin-top: 20px;">
                    <?php
                        include_once "return_request_list.php"; // customer profile page
                    ?>
                 </div>
            </div>
        </div>
