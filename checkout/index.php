        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <!-- Dynamically set Breadcrumb info -->
                    <?php $breadcrumbArr = array("Home" => "../index.php?s=1&p=1", "Shopping Cart" => "../cart_information.php?s=5","Checkout" => "#"); ?>
                    <?php include_once "../include/breadcrumb.php";?>
                    <?php include_once "checkout_details.php";?>
                    <!--<div class="row">
                        <div class="col-xs-12">                            
                        </div>                        
                    </div>-->
