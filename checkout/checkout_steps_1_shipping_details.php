...
?>
<div class="column">
        <input name="shipping_address" value="existing" id="shipping-address-existing" checked="checked" type="radio">
        ...
        <p>
        <input name="shipping_address" value="new" id="shipping-address-new" type="radio">
        <label for="shipping-address-new">I want to use a new address</label>
    </p>
    <div id="shipping-new" style="display: none;" class="block">
                ...
                <div class="col-sm-8">
                    <select class="col-sm-12 form-control" id="country" name="country">
                        ...
                        <?php foreach ($countrys as $county): ?>
                            <option value="<?php echo $county->getCountryId() ?>"><?php echo $county->getName() ?></option>
                        <?php endforeach; ?>
                    </select>
     ...
     <div class="col-lg-12 no-padding col-right">
            <div class="button_blocks">
                <div class="right"><a id="button-shipping-address" class="btn">Continue</a></div>
...
<script>
jQuery( 'input[name=shipping_address]:checked' ).live('click',function(){
